...
nlon=(lon_max-lon_min)/lon_interval+1;%obtain the number of  longitude nodes
nlat=(lat_max-lat_min)/lat_interval+1;%obtain the number of latitude  nodes
Lat=linspace(lat_max,lat_min,nlat); Lon=linspace(lon_min,lon_max,nlon);%vectorize the latitude and longitude
...
if handles.radiobutton1.Value == 1  %perform computations using gravity attraction data
...
else %perform computations using gravity gradient data
